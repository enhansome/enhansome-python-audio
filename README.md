...
* [pedalboard](https://github.com/spotify/pedalboard) ⭐ 6,284 | 🐛 146 | 🌐 C++ | 📅 2026-08-30: Spotify's library for audio effects and processing
* [torchaudio](https://github.com/pytorch/audio) ⭐ 2,932 | 🐛 338 | 🌐 Python | 📅 2026-08-30: Audio data manipulation and transformation powered by PyTorch
...
* [Madmom](https://github.com/CPJKU/madmom) ⭐ 1,704 | 🐛 81 | 🌐 Python | 📅 2026-03-20: Audio signal processing library focused on MIR tasks
...
* [Whisper](https://github.com/openai/whisper) ⭐ 108,164 | 🐛 137 | 🌐 Python | 📅 2026-07-28: OpenAI's robust multilingual speech recognition model
* [faster-whisper](https://github.com/SYSTRAN/faster-whisper) ⭐ 25,149 | 🐛 319 | 🌐 Python | 📅 2025-11-19: CTranslate2 reimplementation of Whisper up to 4x faster
* [WhisperX](https://github.com/m-bain/whisperX) ⭐ 23,819 | 🐛 217 | 🌐 Python | 📅 2026-08-30: Whisper with word-level timestamps and speaker diarization
* [Vosk](https://github.com/alphacep/vosk-api) ⭐ 15,087 | 🐛 602 | 🌐 Jupyter Notebook | 📅 2026-08-09: Offline speech recognition API supporting 20+ languages
* [SpeechBrain](https://github.com/speechbrain/speechbrain) ⭐ 11,795 | 🐛 180 | 🌐 Python | 📅 2026-08-27: PyTorch toolkit for speech processing and conversational AI
* [pyannote-audio](https://github.com/pyannote/pyannote-audio) ⭐ 10,487 | 🐛 37 | 🌐 Jupyter Notebook | 📅 2026-08-04: Neural speaker diarization and voice activity detection
...
* [Spleeter](https://github.com/deezer/spleeter) ⭐ 28,407 | 🐛 279 | 🌐 Python | 📅 2026-06-18: Deezer source separation library (note: Demucs now preferred)
...
* [audio-separator](https://github.com/nomadkaraoke/python-audio-separator) ⭐ 1,334 | 🐛 27 | 🌐 Python | 📅 2026-08-27: Easy stem separation using MDX-Net VR Arch and Demucs models
...
* [basic-pitch](https://github.com/spotify/basic-pitch) ⭐ 5,507 | 🐛 60 | 🌐 Python | 📅 2025-11-13: Spotify's lightweight neural network for polyphonic pitch detection
...
* [AudioCraft](https://github.com/facebookresearch/audiocraft) ⭐ 23,593 | 🐛 395 | 🌐 Jupyter Notebook | 📅 2026-03-03: Meta's library for MusicGen AudioGen EnCodec and MAGNeT models
...
* [beets](https://github.com/beetbox/beets) ⭐ 15,600 | 🐛 718 | 🌐 Python | 📅 2026-08-30: Music library manager and MusicBrainz tagger
* [pygame.mixer](https://github.com/pygame/pygame) ⭐ 8,909 | 🐛 788 | 🌐 C | 📅 2025-11-01: Pygame module for sound loading and playback
* [Mopidy](https://github.com/mopidy/mopidy) ⭐ 8,567 | 🐛 225 | 🌐 Python | 📅 2026-08-20: Extensible music server written in Python
...
* [pyAV](https://github.com/PyAV-org/PyAV) ⭐ 3,272 | 🐛 7 | 🌐 Python | 📅 2026-08-30: Pythonic bindings for FFmpeg libraries
...
* [Whisper tutorial](https://github.com/openai/whisper/discussions/categories/guides) ⭐ 108,164 | 🐛 137 | 🌐 Python | 📅 2026-07-28: Using OpenAI Whisper for speech-to-text
* [AudioCraft tutorial](https://github.com/facebookresearch/audiocraft/blob/main/docs/MUSICGEN.md) ⭐ 23,593 | 🐛 395 | 🌐 Jupyter Notebook | 📅 2026-03-03: Getting started with MusicGen and AudioGen
