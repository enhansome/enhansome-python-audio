...
* [torchaudio](https://github.com/pytorch/audio) ⭐ 2,933 | 🐛 338 | 🌐 Python | 📅 2026-08-31: Audio data manipulation and transformation powered by PyTorch
...
* [soundfile](https://github.com/bastibe/SoundFile) ⭐ 850 | 🐛 135 | 🌐 Python | 📅 2026-07-14: Read and write sound files using libsndfile
...
* [Essentia](https://github.com/MTG/essentia) ⭐ 3,709 | 🐛 435 | 🌐 C++ | 📅 2026-08-27: C++ library with Python bindings for audio analysis and MIR
...
* [CLAP (LAION)](https://github.com/LAION-AI/CLAP) ⭐ 2,258 | 🐛 67 | 🌐 Python | 📅 2025-05-15: Contrastive Language-Audio Pretraining for zero-shot audio classification
...
* [Whisper](https://github.com/openai/whisper) ⭐ 108,225 | 🐛 136 | 🌐 Python | 📅 2026-08-31: OpenAI's robust multilingual speech recognition model
* [faster-whisper](https://github.com/SYSTRAN/faster-whisper) ⭐ 25,166 | 🐛 318 | 🌐 Python | 📅 2025-11-19: CTranslate2 reimplementation of Whisper up to 4x faster
* [WhisperX](https://github.com/m-bain/whisperX) ⭐ 23,830 | 🐛 217 | 🌐 Python | 📅 2026-08-30: Whisper with word-level timestamps and speaker diarization
* [Vosk](https://github.com/alphacep/vosk-api) ⭐ 15,094 | 🐛 604 | 🌐 Jupyter Notebook | 📅 2026-08-09: Offline speech recognition API supporting 20+ languages
* [SpeechBrain](https://github.com/speechbrain/speechbrain) ⭐ 11,798 | 🐛 181 | 🌐 Python | 📅 2026-08-27: PyTorch toolkit for speech processing and conversational AI
* [pyannote-audio](https://github.com/pyannote/pyannote-audio) ⭐ 10,493 | 🐛 37 | 🌐 Jupyter Notebook | 📅 2026-08-04: Neural speaker diarization and voice activity detection
* [SpeechRecognition](https://github.com/Uberi/speech_recognition) ⭐ 8,987 | 🐛 312 | 🌐 Python | 📅 2026-08-31: Library for performing speech recognition with multiple backends

### Text-to-Speech

* [Coqui TTS](https://github.com/coqui-ai/TTS) ⭐ 45,972 | 🐛 2 | 🌐 Python | 📅 2024-08-16: Deep learning toolkit for Text-to-Speech
...
* [Spleeter](https://github.com/deezer/spleeter) ⭐ 28,409 | 🐛 279 | 🌐 Python | 📅 2026-06-18: Deezer source separation library (note: Demucs now preferred)
...
* [audio-separator](https://github.com/nomadkaraoke/python-audio-separator) ⭐ 1,335 | 🐛 27 | 🌐 Python | 📅 2026-08-27: Easy stem separation using MDX-Net VR Arch and Demucs models
...
* [basic-pitch](https://github.com/spotify/basic-pitch) ⭐ 5,509 | 🐛 60 | 🌐 Python | 📅 2025-11-13: Spotify's lightweight neural network for polyphonic pitch detection
...
* [AudioCraft](https://github.com/facebookresearch/audiocraft) ⭐ 23,592 | 🐛 395 | 🌐 Jupyter Notebook | 📅 2026-03-03: Meta's library for MusicGen AudioGen EnCodec and MAGNeT models
...
* [Stable Audio Tools](https://github.com/Stability-AI/stable-audio-tools) ⭐ 3,851 | 🐛 131 | 🌐 Python | 📅 2026-08-21: Generative models for conditional audio generation from Stability AI
...
* [music21](https://github.com/cuthbertLab/music21) ⭐ 2,572 | 🐛 152 | 🌐 Python | 📅 2026-08-28: Toolkit for computer-aided musical analysis
...
* [discord.py](https://github.com/Rapptz/discord.py) ⭐ 16,161 | 🐛 163 | 🌐 Python | 📅 2026-07-27: Python wrapper for Discord API with music streaming
* [beets](https://github.com/beetbox/beets) ⭐ 15,602 | 🐛 712 | 🌐 Python | 📅 2026-08-31: Music library manager and MusicBrainz tagger
* [pygame.mixer](https://github.com/pygame/pygame) ⭐ 8,910 | 🐛 788 | 🌐 C | 📅 2025-11-01: Pygame module for sound loading and playback
* [Mopidy](https://github.com/mopidy/mopidy) ⭐ 8,568 | 🐛 225 | 🌐 Python | 📅 2026-08-20: Extensible music server written in Python
* [Spotipy](https://github.com/spotipy-dev/spotipy) ⭐ 5,470 | 🐛 63 | 🌐 Python | 📅 2026-06-29: Python client for the Spotify Web API
* [MusicBot](https://github.com/just-some-bots/MusicBot) ⭐ 3,282 | 🐛 15 | 🌐 Python | 📅 2026-03-14: Discord music bot written in Python
* [pyAV](https://github.com/PyAV-org/PyAV) ⭐ 3,274 | 🐛 7 | 🌐 Python | 📅 2026-08-30: Pythonic bindings for FFmpeg libraries
...
* [ESC-50](https://github.com/karolpiczak/ESC-50) ⭐ 1,862 | 🐛 3 | 🌐 Python | 📅 2024-03-20: Environmental sound classification dataset
...
* [Whisper tutorial](https://github.com/openai/whisper/discussions/categories/guides) ⭐ 108,225 | 🐛 136 | 🌐 Python | 📅 2026-08-31: Using OpenAI Whisper for speech-to-text
* [AudioCraft tutorial](https://github.com/facebookresearch/audiocraft/blob/main/docs/MUSICGEN.md) ⭐ 23,592 | 🐛 395 | 🌐 Jupyter Notebook | 📅 2026-03-03: Getting started with MusicGen and AudioGen
