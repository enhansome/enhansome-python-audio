...
* [pedalboard](https://github.com/spotify/pedalboard) ⭐ 6,321 | 🐛 142 | 🌐 C++ | 📅 2026-09-23: Spotify's library for audio effects and processing
* [torchaudio](https://github.com/pytorch/audio) ⭐ 2,945 | 🐛 340 | 🌐 Python | 📅 2026-09-24: Audio data manipulation and transformation powered by PyTorch
* [matchering](https://github.com/sergree/matchering) ⭐ 2,645 | 🐛 34 | 🌐 Python | 📅 2026-07-08: Open source audio matching and mastering
...
* [librosa](https://github.com/librosa/librosa) ⭐ 8,625 | 🐛 51 | 🌐 Python | 📅 2026-09-24: Python package for music and audio analysis
...
* [Essentia](https://github.com/MTG/essentia) ⭐ 3,741 | 🐛 440 | 🌐 C++ | 📅 2026-09-21: C++ library with Python bindings for audio analysis and MIR
* [audioFlux](https://github.com/libAudioFlux/audioFlux) ⭐ 3,366 | 🐛 16 | 🌐 C | 📅 2026-03-06: Library for audio and music analysis and feature extraction
...
* [Whisper](https://github.com/openai/whisper) ⭐ 109,560 | 🐛 152 | 🌐 Python | 📅 2026-08-31: OpenAI's robust multilingual speech recognition model
* [faster-whisper](https://github.com/SYSTRAN/faster-whisper) ⭐ 25,554 | 🐛 323 | 🌐 Python | 📅 2025-11-19: CTranslate2 reimplementation of Whisper up to 4x faster
* [WhisperX](https://github.com/m-bain/whisperX) ⭐ 24,229 | 🐛 227 | 🌐 Python | 📅 2026-08-30: Whisper with word-level timestamps and speaker diarization
* [Vosk](https://github.com/alphacep/vosk-api) ⭐ 15,145 | 🐛 605 | 🌐 Jupyter Notebook | 📅 2026-08-09: Offline speech recognition API supporting 20+ languages
* [SpeechBrain](https://github.com/speechbrain/speechbrain) ⭐ 11,841 | 🐛 189 | 🌐 Python | 📅 2026-08-27: PyTorch toolkit for speech processing and conversational AI
* [pyannote-audio](https://github.com/pyannote/pyannote-audio) ⭐ 10,593 | 🐛 43 | 🌐 Jupyter Notebook | 📅 2026-09-24: Neural speaker diarization and voice activity detection
...
* [Coqui TTS](https://github.com/coqui-ai/TTS) ⭐ 46,061 | 🐛 3 | 🌐 Python | 📅 2024-08-16: Deep learning toolkit for Text-to-Speech
...
* [Spleeter](https://github.com/deezer/spleeter) ⭐ 28,477 | 🐛 279 | 🌐 Python | 📅 2026-06-18: Deezer source separation library (note: Demucs now preferred)
...
* [audio-separator](https://github.com/nomadkaraoke/python-audio-separator) ⭐ 1,382 | 🐛 27 | 🌐 Python | 📅 2026-08-27: Easy stem separation using MDX-Net VR Arch and Demucs models
...
* [basic-pitch](https://github.com/spotify/basic-pitch) ⭐ 5,620 | 🐛 61 | 🌐 Python | 📅 2025-11-13: Spotify's lightweight neural network for polyphonic pitch detection
* [MT3](https://github.com/magenta/mt3) ⭐ 1,756 | 🐛 51 | 🌐 Python | 📅 2026-09-15: Multi-instrument automatic music transcription from Google Magenta
...
* [AudioCraft](https://github.com/facebookresearch/audiocraft) ⭐ 23,650 | 🐛 398 | 🌐 Jupyter Notebook | 📅 2026-03-03: Meta's library for MusicGen AudioGen EnCodec and MAGNeT models
...
* [scamp](https://github.com/MarcTheSpark/scamp) ⭐ 153 | 🐛 9 | 🌐 Python | 📅 2026-09-24: Suite for Computer-Assisted Music in Python
* [maelzel](https://github.com/gesellkammer/maelzel) ⭐ 30 | 🐛 1 | 🌐 Jupyter Notebook | 📅 2026-07-09: Framework for computer music in Python
* [AthenaCL](https://github.com/ales-tsurko/athenaCL) ⭐ 18 | 🐛 6 | 🌐 Python | 📅 2026-09-24: Algorithmic composition tool (Python 3 fork)
* [xenharmlib](https://gitlab.com/retooth/xenharmlib): Music theory library for microtonal and non-standard tuning systems

## Playback & Services

* [discord.py](https://github.com/Rapptz/discord.py) ⭐ 16,186 | 🐛 173 | 🌐 Python | 📅 2026-09-07: Python wrapper for Discord API with music streaming
* [beets](https://github.com/beetbox/beets) ⭐ 15,705 | 🐛 710 | 🌐 Python | 📅 2026-09-23: Music library manager and MusicBrainz tagger
* [pygame.mixer](https://github.com/pygame/pygame) ⭐ 8,946 | 🐛 794 | 🌐 C | 📅 2025-11-01: Pygame module for sound loading and playback
...
* [pyAV](https://github.com/PyAV-org/PyAV) ⭐ 3,290 | 🐛 6 | 🌐 Python | 📅 2026-09-23: Pythonic bindings for FFmpeg libraries
* [MusicBot](https://github.com/just-some-bots/MusicBot) ⭐ 3,289 | 🐛 15 | 🌐 Python | 📅 2026-03-14: Discord music bot written in Python
* [pyglet](https://github.com/pyglet/pyglet) ⭐ 2,214 | 🐛 33 | 🌐 Python | 📅 2026-09-23: Cross-platform windowing and multimedia library
...
* [ESC-50](https://github.com/karolpiczak/ESC-50) ⭐ 1,872 | 🐛 3 | 🌐 Python | 📅 2024-03-20: Environmental sound classification dataset
...
* [Whisper tutorial](https://github.com/openai/whisper/discussions/categories/guides) ⭐ 109,560 | 🐛 152 | 🌐 Python | 📅 2026-08-31: Using OpenAI Whisper for speech-to-text
* [AudioCraft tutorial](https://github.com/facebookresearch/audiocraft/blob/main/docs/MUSICGEN.md) ⭐ 23,650 | 🐛 398 | 🌐 Jupyter Notebook | 📅 2026-03-03: Getting started with MusicGen and AudioGen
