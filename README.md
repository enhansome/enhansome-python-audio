...
* [PyDub](https://github.com/jiaaro/pydub) ⭐ 9,797 | 🐛 423 | 🌐 Python | 📅 2026-03-19: Manipulate audio with a simple and easy high level interface
* [pedalboard](https://github.com/spotify/pedalboard) ⭐ 6,315 | 🐛 143 | 🌐 C++ | 📅 2026-09-17: Spotify's library for audio effects and processing
* [torchaudio](https://github.com/pytorch/audio) ⭐ 2,943 | 🐛 340 | 🌐 Python | 📅 2026-09-20: Audio data manipulation and transformation powered by PyTorch
* [matchering](https://github.com/sergree/matchering) ⭐ 2,638 | 🐛 34 | 🌐 Python | 📅 2026-07-08: Open source audio matching and mastering
...
* [librosa](https://github.com/librosa/librosa) ⭐ 8,617 | 🐛 52 | 🌐 Python | 📅 2026-09-18: Python package for music and audio analysis
...
* [Essentia](https://github.com/MTG/essentia) ⭐ 3,728 | 🐛 440 | 🌐 C++ | 📅 2026-08-27: C++ library with Python bindings for audio analysis and MIR
* [audioFlux](https://github.com/libAudioFlux/audioFlux) ⭐ 3,365 | 🐛 16 | 🌐 C | 📅 2026-03-06: Library for audio and music analysis and feature extraction
...
* [CLAP (LAION)](https://github.com/LAION-AI/CLAP) ⭐ 2,278 | 🐛 68 | 🌐 Python | 📅 2025-05-15: Contrastive Language-Audio Pretraining for zero-shot audio classification
...
* [panns-inference](https://github.com/qiuqiangkong/panns_inference) ⭐ 274 | 🐛 17 | 🌐 Python | 📅 2024-03-05: Pretrained audio neural networks for audio tagging and sound event detection
...
* [Whisper](https://github.com/openai/whisper) ⭐ 109,411 | 🐛 151 | 🌐 Python | 📅 2026-08-31: OpenAI's robust multilingual speech recognition model
* [faster-whisper](https://github.com/SYSTRAN/faster-whisper) ⭐ 25,484 | 🐛 323 | 🌐 Python | 📅 2025-11-19: CTranslate2 reimplementation of Whisper up to 4x faster
* [WhisperX](https://github.com/m-bain/whisperX) ⭐ 24,153 | 🐛 223 | 🌐 Python | 📅 2026-08-30: Whisper with word-level timestamps and speaker diarization
* [Vosk](https://github.com/alphacep/vosk-api) ⭐ 15,141 | 🐛 605 | 🌐 Jupyter Notebook | 📅 2026-08-09: Offline speech recognition API supporting 20+ languages
* [SpeechBrain](https://github.com/speechbrain/speechbrain) ⭐ 11,828 | 🐛 189 | 🌐 Python | 📅 2026-08-27: PyTorch toolkit for speech processing and conversational AI
* [pyannote-audio](https://github.com/pyannote/pyannote-audio) ⭐ 10,574 | 🐛 43 | 🌐 Jupyter Notebook | 📅 2026-09-18: Neural speaker diarization and voice activity detection
* [SpeechRecognition](https://github.com/Uberi/speech_recognition) ⭐ 8,989 | 🐛 312 | 🌐 Python | 📅 2026-09-02: Library for performing speech recognition with multiple backends

### Text-to-Speech

* [Coqui TTS](https://github.com/coqui-ai/TTS) ⭐ 46,034 | 🐛 3 | 🌐 Python | 📅 2024-08-16: Deep learning toolkit for Text-to-Speech
...
* [Spleeter](https://github.com/deezer/spleeter) ⭐ 28,464 | 🐛 280 | 🌐 Python | 📅 2026-06-18: Deezer source separation library (note: Demucs now preferred)
...
* [audio-separator](https://github.com/nomadkaraoke/python-audio-separator) ⭐ 1,375 | 🐛 27 | 🌐 Python | 📅 2026-08-27: Easy stem separation using MDX-Net VR Arch and Demucs models
...
* [basic-pitch](https://github.com/spotify/basic-pitch) ⭐ 5,604 | 🐛 61 | 🌐 Python | 📅 2025-11-13: Spotify's lightweight neural network for polyphonic pitch detection
...
* [AudioCraft](https://github.com/facebookresearch/audiocraft) ⭐ 23,642 | 🐛 398 | 🌐 Jupyter Notebook | 📅 2026-03-03: Meta's library for MusicGen AudioGen EnCodec and MAGNeT models
...
* [Stable Audio Tools](https://github.com/Stability-AI/stable-audio-tools) ⭐ 3,862 | 🐛 132 | 🌐 Python | 📅 2026-09-18: Generative models for conditional audio generation from Stability AI
...
* [Mido](https://github.com/mido/mido) ⭐ 1,642 | 🐛 122 | 🌐 Python | 📅 2026-09-16: MIDI objects for Python
...
* [music21](https://github.com/cuthbertLab/music21) ⭐ 2,585 | 🐛 154 | 🌐 Python | 📅 2026-09-19: Toolkit for computer-aided musical analysis
...
* [AthenaCL](https://github.com/ales-tsurko/athenaCL) ⭐ 18 | 🐛 6 | 🌐 Python | 📅 2026-09-20: Algorithmic composition tool (Python 3 fork)
* [xenharmlib](https://gitlab.com/retooth/xenharmlib): Music theory library for microtonal and non-standard tuning systems

## Playback & Services

* [discord.py](https://github.com/Rapptz/discord.py) ⭐ 16,190 | 🐛 172 | 🌐 Python | 📅 2026-09-07: Python wrapper for Discord API with music streaming
* [beets](https://github.com/beetbox/beets) ⭐ 15,681 | 🐛 710 | 🌐 Python | 📅 2026-09-20: Music library manager and MusicBrainz tagger
* [pygame.mixer](https://github.com/pygame/pygame) ⭐ 8,943 | 🐛 792 | 🌐 C | 📅 2025-11-01: Pygame module for sound loading and playback
* [Mopidy](https://github.com/mopidy/mopidy) ⭐ 8,584 | 🐛 213 | 🌐 Python | 📅 2026-09-19: Extensible music server written in Python
...
* [pyAV](https://github.com/PyAV-org/PyAV) ⭐ 3,286 | 🐛 8 | 🌐 Python | 📅 2026-09-17: Pythonic bindings for FFmpeg libraries
* [pyglet](https://github.com/pyglet/pyglet) ⭐ 2,213 | 🐛 35 | 🌐 Python | 📅 2026-09-20: Cross-platform windowing and multimedia library
...
* [Whisper tutorial](https://github.com/openai/whisper/discussions/categories/guides) ⭐ 109,411 | 🐛 151 | 🌐 Python | 📅 2026-08-31: Using OpenAI Whisper for speech-to-text
* [AudioCraft tutorial](https://github.com/facebookresearch/audiocraft/blob/main/docs/MUSICGEN.md) ⭐ 23,642 | 🐛 398 | 🌐 Jupyter Notebook | 📅 2026-03-03: Getting started with MusicGen and AudioGen
