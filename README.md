...
* [pedalboard](https://github.com/spotify/pedalboard) ⭐ 6,280 | 🐛 147 | 🌐 C++ | 📅 2026-08-24: Spotify's library for audio effects and processing
* [torchaudio](https://github.com/pytorch/audio) ⭐ 2,927 | 🐛 338 | 🌐 Python | 📅 2026-08-26: Audio data manipulation and transformation powered by PyTorch
...
* [librosa](https://github.com/librosa/librosa) ⭐ 8,576 | 🐛 51 | 🌐 Python | 📅 2026-08-22: Python package for music and audio analysis
...
* [Essentia](https://github.com/MTG/essentia) ⭐ 3,705 | 🐛 425 | 🌐 C++ | 📅 2026-07-22: C++ library with Python bindings for audio analysis and MIR
* [audioFlux](https://github.com/libAudioFlux/audioFlux) ⭐ 3,351 | 🐛 16 | 🌐 C | 📅 2026-03-06: Library for audio and music analysis and feature extraction
* [Madmom](https://github.com/CPJKU/madmom) ⭐ 1,699 | 🐛 81 | 🌐 Python | 📅 2026-03-20: Audio signal processing library focused on MIR tasks
...
* [CLAP (LAION)](https://github.com/LAION-AI/CLAP) ⭐ 2,256 | 🐛 67 | 🌐 Python | 📅 2025-05-15: Contrastive Language-Audio Pretraining for zero-shot audio classification
...
* [Whisper](https://github.com/openai/whisper) ⭐ 107,987 | 🐛 137 | 🌐 Python | 📅 2026-07-28: OpenAI's robust multilingual speech recognition model
* [faster-whisper](https://github.com/SYSTRAN/faster-whisper) ⭐ 25,105 | 🐛 319 | 🌐 Python | 📅 2025-11-19: CTranslate2 reimplementation of Whisper up to 4x faster
* [WhisperX](https://github.com/m-bain/whisperX) ⭐ 23,766 | 🐛 212 | 🌐 Python | 📅 2026-07-13: Whisper with word-level timestamps and speaker diarization
* [Vosk](https://github.com/alphacep/vosk-api) ⭐ 15,078 | 🐛 601 | 🌐 Jupyter Notebook | 📅 2026-08-09: Offline speech recognition API supporting 20+ languages
* [SpeechBrain](https://github.com/speechbrain/speechbrain) ⭐ 11,785 | 🐛 177 | 🌐 Python | 📅 2026-08-25: PyTorch toolkit for speech processing and conversational AI
* [pyannote-audio](https://github.com/pyannote/pyannote-audio) ⭐ 10,476 | 🐛 36 | 🌐 Jupyter Notebook | 📅 2026-08-04: Neural speaker diarization and voice activity detection
...
* [Coqui TTS](https://github.com/coqui-ai/TTS) ⭐ 45,954 | 🐛 2 | 🌐 Python | 📅 2024-08-16: Deep learning toolkit for Text-to-Speech
...
* [audio-separator](https://github.com/nomadkaraoke/python-audio-separator) ⭐ 1,327 | 🐛 26 | 🌐 Python | 📅 2026-08-27: Easy stem separation using MDX-Net VR Arch and Demucs models
...
* [basic-pitch](https://github.com/spotify/basic-pitch) ⭐ 5,489 | 🐛 59 | 🌐 Python | 📅 2025-11-13: Spotify's lightweight neural network for polyphonic pitch detection
* [MT3](https://github.com/magenta/mt3) ⭐ 1,744 | 🐛 51 | 🌐 Python | 📅 2026-07-09: Multi-instrument automatic music transcription from Google Magenta
...
* [AudioCraft](https://github.com/facebookresearch/audiocraft) ⭐ 23,586 | 🐛 394 | 🌐 Jupyter Notebook | 📅 2026-03-03: Meta's library for MusicGen AudioGen EnCodec and MAGNeT models
...
* [Stable Audio Tools](https://github.com/Stability-AI/stable-audio-tools) ⭐ 3,850 | 🐛 130 | 🌐 Python | 📅 2026-08-21: Generative models for conditional audio generation from Stability AI
...
* [discord.py](https://github.com/Rapptz/discord.py) ⭐ 16,155 | 🐛 161 | 🌐 Python | 📅 2026-07-27: Python wrapper for Discord API with music streaming
* [beets](https://github.com/beetbox/beets) ⭐ 15,591 | 🐛 714 | 🌐 Python | 📅 2026-08-27: Music library manager and MusicBrainz tagger
* [pygame.mixer](https://github.com/pygame/pygame) ⭐ 8,906 | 🐛 788 | 🌐 C | 📅 2025-11-01: Pygame module for sound loading and playback
* [Mopidy](https://github.com/mopidy/mopidy) ⭐ 8,563 | 🐛 225 | 🌐 Python | 📅 2026-08-20: Extensible music server written in Python
...
* [pyAV](https://github.com/PyAV-org/PyAV) ⭐ 3,269 | 🐛 5 | 🌐 Python | 📅 2026-08-26: Pythonic bindings for FFmpeg libraries
* [pyglet](https://github.com/pyglet/pyglet) ⭐ 2,210 | 🐛 45 | 🌐 Python | 📅 2026-08-25: Cross-platform windowing and multimedia library
* [pyradio](https://github.com/coderholic/pyradio) ⭐ 1,092 | 🐛 11 | 🌐 Python | 📅 2026-05-07: Command line internet radio player
...
* [FMA](https://github.com/mdeff/fma) ⭐ 2,653 | 🐛 15 | 🌐 Jupyter Notebook | 📅 2023-01-05: Free Music Archive dataset for music analysis
...
* [Whisper tutorial](https://github.com/openai/whisper/discussions/categories/guides) ⭐ 107,987 | 🐛 137 | 🌐 Python | 📅 2026-07-28: Using OpenAI Whisper for speech-to-text
* [AudioCraft tutorial](https://github.com/facebookresearch/audiocraft/blob/main/docs/MUSICGEN.md) ⭐ 23,586 | 🐛 394 | 🌐 Jupyter Notebook | 📅 2026-03-03: Getting started with MusicGen and AudioGen
