...
* [pedalboard](https://github.com/spotify/pedalboard) ⭐ 6,282 | 🐛 147 | 🌐 C++ | 📅 2026-08-24: Spotify's library for audio effects and processing
* [torchaudio](https://github.com/pytorch/audio) ⭐ 2,930 | 🐛 338 | 🌐 Python | 📅 2026-08-27: Audio data manipulation and transformation powered by PyTorch
...
* [librosa](https://github.com/librosa/librosa) ⭐ 8,578 | 🐛 51 | 🌐 Python | 📅 2026-08-22: Python package for music and audio analysis
...
* [Essentia](https://github.com/MTG/essentia) ⭐ 3,706 | 🐛 435 | 🌐 C++ | 📅 2026-08-27: C++ library with Python bindings for audio analysis and MIR
* [audioFlux](https://github.com/libAudioFlux/audioFlux) ⭐ 3,352 | 🐛 16 | 🌐 C | 📅 2026-03-06: Library for audio and music analysis and feature extraction
* [Madmom](https://github.com/CPJKU/madmom) ⭐ 1,702 | 🐛 81 | 🌐 Python | 📅 2026-03-20: Audio signal processing library focused on MIR tasks
...
* [CLAP (LAION)](https://github.com/LAION-AI/CLAP) ⭐ 2,257 | 🐛 67 | 🌐 Python | 📅 2025-05-15: Contrastive Language-Audio Pretraining for zero-shot audio classification
...
* [Whisper](https://github.com/openai/whisper) ⭐ 108,039 | 🐛 136 | 🌐 Python | 📅 2026-07-28: OpenAI's robust multilingual speech recognition model
* [faster-whisper](https://github.com/SYSTRAN/faster-whisper) ⭐ 25,119 | 🐛 319 | 🌐 Python | 📅 2025-11-19: CTranslate2 reimplementation of Whisper up to 4x faster
* [WhisperX](https://github.com/m-bain/whisperX) ⭐ 23,782 | 🐛 215 | 🌐 Python | 📅 2026-07-13: Whisper with word-level timestamps and speaker diarization
* [Vosk](https://github.com/alphacep/vosk-api) ⭐ 15,080 | 🐛 602 | 🌐 Jupyter Notebook | 📅 2026-08-09: Offline speech recognition API supporting 20+ languages
* [SpeechBrain](https://github.com/speechbrain/speechbrain) ⭐ 11,788 | 🐛 177 | 🌐 Python | 📅 2026-08-27: PyTorch toolkit for speech processing and conversational AI
* [pyannote-audio](https://github.com/pyannote/pyannote-audio) ⭐ 10,479 | 🐛 36 | 🌐 Jupyter Notebook | 📅 2026-08-04: Neural speaker diarization and voice activity detection
...
* [Coqui TTS](https://github.com/coqui-ai/TTS) ⭐ 45,963 | 🐛 2 | 🌐 Python | 📅 2024-08-16: Deep learning toolkit for Text-to-Speech
* [Bark](https://github.com/suno-ai/bark) ⭐ 39,253 | 🐛 268 | 🌐 Jupyter Notebook | 📅 2024-08-19: Transformer-based text-to-audio model with emotions and non-speech sounds
...
* [audio-separator](https://github.com/nomadkaraoke/python-audio-separator) ⭐ 1,329 | 🐛 27 | 🌐 Python | 📅 2026-08-27: Easy stem separation using MDX-Net VR Arch and Demucs models
...
* [basic-pitch](https://github.com/spotify/basic-pitch) ⭐ 5,490 | 🐛 59 | 🌐 Python | 📅 2025-11-13: Spotify's lightweight neural network for polyphonic pitch detection
...
* [AudioCraft](https://github.com/facebookresearch/audiocraft) ⭐ 23,587 | 🐛 394 | 🌐 Jupyter Notebook | 📅 2026-03-03: Meta's library for MusicGen AudioGen EnCodec and MAGNeT models
...
* [Stable Audio Tools](https://github.com/Stability-AI/stable-audio-tools) ⭐ 3,852 | 🐛 130 | 🌐 Python | 📅 2026-08-21: Generative models for conditional audio generation from Stability AI
...
* [music21](https://github.com/cuthbertLab/music21) ⭐ 2,570 | 🐛 153 | 🌐 Python | 📅 2026-08-28: Toolkit for computer-aided musical analysis
...
* [beets](https://github.com/beetbox/beets) ⭐ 15,593 | 🐛 714 | 🌐 Python | 📅 2026-08-27: Music library manager and MusicBrainz tagger
...
* [pyAV](https://github.com/PyAV-org/PyAV) ⭐ 3,270 | 🐛 5 | 🌐 Python | 📅 2026-08-27: Pythonic bindings for FFmpeg libraries
* [pyglet](https://github.com/pyglet/pyglet) ⭐ 2,210 | 🐛 44 | 🌐 Python | 📅 2026-08-27: Cross-platform windowing and multimedia library
...
* [ESC-50](https://github.com/karolpiczak/ESC-50) ⭐ 1,861 | 🐛 3 | 🌐 Python | 📅 2024-03-20: Environmental sound classification dataset
...
* [Whisper tutorial](https://github.com/openai/whisper/discussions/categories/guides) ⭐ 108,039 | 🐛 136 | 🌐 Python | 📅 2026-07-28: Using OpenAI Whisper for speech-to-text
* [AudioCraft tutorial](https://github.com/facebookresearch/audiocraft/blob/main/docs/MUSICGEN.md) ⭐ 23,587 | 🐛 394 | 🌐 Jupyter Notebook | 📅 2026-03-03: Getting started with MusicGen and AudioGen
