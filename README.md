...
* [pedalboard](https://github.com/spotify/pedalboard) ⭐ 6,286 | 🐛 146 | 🌐 C++ | 📅 2026-08-31: Spotify's library for audio effects and processing
* [torchaudio](https://github.com/pytorch/audio) ⭐ 2,933 | 🐛 338 | 🌐 Python | 📅 2026-09-01: Audio data manipulation and transformation powered by PyTorch
...
* [librosa](https://github.com/librosa/librosa) ⭐ 8,583 | 🐛 51 | 🌐 Python | 📅 2026-08-22: Python package for music and audio analysis
...
* [Essentia](https://github.com/MTG/essentia) ⭐ 3,711 | 🐛 435 | 🌐 C++ | 📅 2026-08-27: C++ library with Python bindings for audio analysis and MIR
...
* [Whisper](https://github.com/openai/whisper) ⭐ 108,285 | 🐛 138 | 🌐 Python | 📅 2026-08-31: OpenAI's robust multilingual speech recognition model
* [faster-whisper](https://github.com/SYSTRAN/faster-whisper) ⭐ 25,186 | 🐛 318 | 🌐 Python | 📅 2025-11-19: CTranslate2 reimplementation of Whisper up to 4x faster
* [WhisperX](https://github.com/m-bain/whisperX) ⭐ 23,843 | 🐛 217 | 🌐 Python | 📅 2026-08-30: Whisper with word-level timestamps and speaker diarization
* [Vosk](https://github.com/alphacep/vosk-api) ⭐ 15,100 | 🐛 604 | 🌐 Jupyter Notebook | 📅 2026-08-09: Offline speech recognition API supporting 20+ languages
* [SpeechBrain](https://github.com/speechbrain/speechbrain) ⭐ 11,801 | 🐛 181 | 🌐 Python | 📅 2026-08-27: PyTorch toolkit for speech processing and conversational AI
* [pyannote-audio](https://github.com/pyannote/pyannote-audio) ⭐ 10,498 | 🐛 37 | 🌐 Jupyter Notebook | 📅 2026-08-04: Neural speaker diarization and voice activity detection
...
* [Coqui TTS](https://github.com/coqui-ai/TTS) ⭐ 45,979 | 🐛 2 | 🌐 Python | 📅 2024-08-16: Deep learning toolkit for Text-to-Speech
* [Bark](https://github.com/suno-ai/bark) ⭐ 39,260 | 🐛 268 | 🌐 Jupyter Notebook | 📅 2024-08-19: Transformer-based text-to-audio model with emotions and non-speech sounds
* [pyttsx3](https://github.com/nateshmbhat/pyttsx3) ⭐ 2,529 | 🐛 90 | 🌐 Python | 📅 2026-07-22: Offline text-to-speech conversion library

## Source Separation

* [Spleeter](https://github.com/deezer/spleeter) ⭐ 28,413 | 🐛 279 | 🌐 Python | 📅 2026-06-18: Deezer source separation library (note: Demucs now preferred)
...
* [audio-separator](https://github.com/nomadkaraoke/python-audio-separator) ⭐ 1,338 | 🐛 27 | 🌐 Python | 📅 2026-08-27: Easy stem separation using MDX-Net VR Arch and Demucs models
...
* [basic-pitch](https://github.com/spotify/basic-pitch) ⭐ 5,517 | 🐛 60 | 🌐 Python | 📅 2025-11-13: Spotify's lightweight neural network for polyphonic pitch detection
...
* [Stable Audio Tools](https://github.com/Stability-AI/stable-audio-tools) ⭐ 3,852 | 🐛 131 | 🌐 Python | 📅 2026-08-21: Generative models for conditional audio generation from Stability AI
...
* [music21](https://github.com/cuthbertLab/music21) ⭐ 2,573 | 🐛 152 | 🌐 Python | 📅 2026-09-01: Toolkit for computer-aided musical analysis
...
* [beets](https://github.com/beetbox/beets) ⭐ 15,607 | 🐛 717 | 🌐 Python | 📅 2026-09-02: Music library manager and MusicBrainz tagger
* [pygame.mixer](https://github.com/pygame/pygame) ⭐ 8,912 | 🐛 788 | 🌐 C | 📅 2025-11-01: Pygame module for sound loading and playback
...
* [pyAV](https://github.com/PyAV-org/PyAV) ⭐ 3,275 | 🐛 8 | 🌐 Python | 📅 2026-09-01: Pythonic bindings for FFmpeg libraries
* [pyglet](https://github.com/pyglet/pyglet) ⭐ 2,211 | 🐛 36 | 🌐 Python | 📅 2026-08-29: Cross-platform windowing and multimedia library
...
* [ESC-50](https://github.com/karolpiczak/ESC-50) ⭐ 1,863 | 🐛 3 | 🌐 Python | 📅 2024-03-20: Environmental sound classification dataset
...
* [Whisper tutorial](https://github.com/openai/whisper/discussions/categories/guides) ⭐ 108,285 | 🐛 138 | 🌐 Python | 📅 2026-08-31: Using OpenAI Whisper for speech-to-text
