...
* [pedalboard](https://github.com/spotify/pedalboard) ⭐ 6,286 | 🐛 147 | 🌐 C++ | 📅 2026-08-31: Spotify's library for audio effects and processing
* [torchaudio](https://github.com/pytorch/audio) ⭐ 2,933 | 🐛 339 | 🌐 Python | 📅 2026-09-02: Audio data manipulation and transformation powered by PyTorch
...
* [soundfile](https://github.com/bastibe/SoundFile) ⭐ 850 | 🐛 136 | 🌐 Python | 📅 2026-07-14: Read and write sound files using libsndfile
...
* [librosa](https://github.com/librosa/librosa) ⭐ 8,582 | 🐛 51 | 🌐 Python | 📅 2026-08-22: Python package for music and audio analysis
...
* [Essentia](https://github.com/MTG/essentia) ⭐ 3,711 | 🐛 434 | 🌐 C++ | 📅 2026-08-27: C++ library with Python bindings for audio analysis and MIR
...
* [Madmom](https://github.com/CPJKU/madmom) ⭐ 1,705 | 🐛 81 | 🌐 Python | 📅 2026-03-20: Audio signal processing library focused on MIR tasks
...
* [Whisper](https://github.com/openai/whisper) ⭐ 108,334 | 🐛 138 | 🌐 Python | 📅 2026-08-31: OpenAI's robust multilingual speech recognition model
* [faster-whisper](https://github.com/SYSTRAN/faster-whisper) ⭐ 25,204 | 🐛 319 | 🌐 Python | 📅 2025-11-19: CTranslate2 reimplementation of Whisper up to 4x faster
* [WhisperX](https://github.com/m-bain/whisperX) ⭐ 23,861 | 🐛 217 | 🌐 Python | 📅 2026-08-30: Whisper with word-level timestamps and speaker diarization
* [Vosk](https://github.com/alphacep/vosk-api) ⭐ 15,101 | 🐛 604 | 🌐 Jupyter Notebook | 📅 2026-08-09: Offline speech recognition API supporting 20+ languages
...
* [pyannote-audio](https://github.com/pyannote/pyannote-audio) ⭐ 10,500 | 🐛 38 | 🌐 Jupyter Notebook | 📅 2026-09-02: Neural speaker diarization and voice activity detection
...
* [Coqui TTS](https://github.com/coqui-ai/TTS) ⭐ 45,984 | 🐛 2 | 🌐 Python | 📅 2024-08-16: Deep learning toolkit for Text-to-Speech
* [Bark](https://github.com/suno-ai/bark) ⭐ 39,258 | 🐛 268 | 🌐 Jupyter Notebook | 📅 2024-08-19: Transformer-based text-to-audio model with emotions and non-speech sounds
* [pyttsx3](https://github.com/nateshmbhat/pyttsx3) ⭐ 2,530 | 🐛 90 | 🌐 Python | 📅 2026-07-22: Offline text-to-speech conversion library

## Source Separation

* [Spleeter](https://github.com/deezer/spleeter) ⭐ 28,412 | 🐛 279 | 🌐 Python | 📅 2026-06-18: Deezer source separation library (note: Demucs now preferred)
* [Demucs](https://github.com/facebookresearch/demucs) ⚠️ Archived: State-of-the-art music source separation from Meta
* [Asteroid](https://github.com/asteroid-team/asteroid) ⭐ 2,585 | 🐛 55 | 🌐 Python | 📅 2026-05-13: PyTorch-based audio source separation toolkit for researchers
...
* [basic-pitch](https://github.com/spotify/basic-pitch) ⭐ 5,522 | 🐛 60 | 🌐 Python | 📅 2025-11-13: Spotify's lightweight neural network for polyphonic pitch detection
...
* [AudioCraft](https://github.com/facebookresearch/audiocraft) ⭐ 23,596 | 🐛 395 | 🌐 Jupyter Notebook | 📅 2026-03-03: Meta's library for MusicGen AudioGen EnCodec and MAGNeT models
...
* [discord.py](https://github.com/Rapptz/discord.py) ⭐ 16,161 | 🐛 163 | 🌐 Python | 📅 2026-09-01: Python wrapper for Discord API with music streaming
* [beets](https://github.com/beetbox/beets) ⭐ 15,610 | 🐛 714 | 🌐 Python | 📅 2026-09-02: Music library manager and MusicBrainz tagger
* [pygame.mixer](https://github.com/pygame/pygame) ⭐ 8,914 | 🐛 788 | 🌐 C | 📅 2025-11-01: Pygame module for sound loading and playback
* [Mopidy](https://github.com/mopidy/mopidy) ⭐ 8,568 | 🐛 222 | 🌐 Python | 📅 2026-09-01: Extensible music server written in Python
...
* [pyglet](https://github.com/pyglet/pyglet) ⭐ 2,211 | 🐛 36 | 🌐 Python | 📅 2026-09-02: Cross-platform windowing and multimedia library
...
* [FMA](https://github.com/mdeff/fma) ⭐ 2,655 | 🐛 15 | 🌐 Jupyter Notebook | 📅 2023-01-05: Free Music Archive dataset for music analysis
...
* [Jamendo Audio Tagging](https://github.com/MTG/mtg-jamendo-dataset) ⭐ 404 | 🐛 13 | 🌐 Python | 📅 2026-03-18: Multi-label audio tagging dataset
...
* [Whisper tutorial](https://github.com/openai/whisper/discussions/categories/guides) ⭐ 108,334 | 🐛 138 | 🌐 Python | 📅 2026-08-31: Using OpenAI Whisper for speech-to-text
* [AudioCraft tutorial](https://github.com/facebookresearch/audiocraft/blob/main/docs/MUSICGEN.md) ⭐ 23,596 | 🐛 395 | 🌐 Jupyter Notebook | 📅 2026-03-03: Getting started with MusicGen and AudioGen
