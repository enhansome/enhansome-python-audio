...
* [PyDub](https://github.com/jiaaro/pydub) ⭐ 9,799 | 🐛 423 | 🌐 Python | 📅 2026-03-19: Manipulate audio with a simple and easy high level interface
* [pedalboard](https://github.com/spotify/pedalboard) ⭐ 6,319 | 🐛 142 | 🌐 C++ | 📅 2026-09-23: Spotify's library for audio effects and processing
* [torchaudio](https://github.com/pytorch/audio) ⭐ 2,943 | 🐛 340 | 🌐 Python | 📅 2026-09-23: Audio data manipulation and transformation powered by PyTorch
* [matchering](https://github.com/sergree/matchering) ⭐ 2,644 | 🐛 34 | 🌐 Python | 📅 2026-07-08: Open source audio matching and mastering
...
* [noisereduce](https://github.com/timsainb/noisereduce) ⭐ 1,877 | 🐛 37 | 🌐 Jupyter Notebook | 📅 2025-08-19: Noise reduction using spectral gating
...
* [soundfile](https://github.com/bastibe/SoundFile) ⭐ 859 | 🐛 137 | 🌐 Python | 📅 2026-07-14: Read and write sound files using libsndfile
...
* [librosa](https://github.com/librosa/librosa) ⭐ 8,623 | 🐛 52 | 🌐 Python | 📅 2026-09-21: Python package for music and audio analysis
...
* [Essentia](https://github.com/MTG/essentia) ⭐ 3,740 | 🐛 439 | 🌐 C++ | 📅 2026-09-21: C++ library with Python bindings for audio analysis and MIR
...
* [Madmom](https://github.com/CPJKU/madmom) ⭐ 1,714 | 🐛 81 | 🌐 Python | 📅 2026-03-20: Audio signal processing library focused on MIR tasks
...
* [CLAP (LAION)](https://github.com/LAION-AI/CLAP) ⭐ 2,282 | 🐛 68 | 🌐 Python | 📅 2025-05-15: Contrastive Language-Audio Pretraining for zero-shot audio classification
...
* [Whisper](https://github.com/openai/whisper) ⭐ 109,525 | 🐛 151 | 🌐 Python | 📅 2026-08-31: OpenAI's robust multilingual speech recognition model
* [faster-whisper](https://github.com/SYSTRAN/faster-whisper) ⭐ 25,539 | 🐛 323 | 🌐 Python | 📅 2025-11-19: CTranslate2 reimplementation of Whisper up to 4x faster
* [WhisperX](https://github.com/m-bain/whisperX) ⭐ 24,210 | 🐛 226 | 🌐 Python | 📅 2026-08-30: Whisper with word-level timestamps and speaker diarization
* [Vosk](https://github.com/alphacep/vosk-api) ⭐ 15,142 | 🐛 605 | 🌐 Jupyter Notebook | 📅 2026-08-09: Offline speech recognition API supporting 20+ languages
* [SpeechBrain](https://github.com/speechbrain/speechbrain) ⭐ 11,838 | 🐛 189 | 🌐 Python | 📅 2026-08-27: PyTorch toolkit for speech processing and conversational AI
* [pyannote-audio](https://github.com/pyannote/pyannote-audio) ⭐ 10,590 | 🐛 42 | 🌐 Jupyter Notebook | 📅 2026-09-22: Neural speaker diarization and voice activity detection
...
* [Coqui TTS](https://github.com/coqui-ai/TTS) ⭐ 46,055 | 🐛 3 | 🌐 Python | 📅 2024-08-16: Deep learning toolkit for Text-to-Speech
...
* [Spleeter](https://github.com/deezer/spleeter) ⭐ 28,472 | 🐛 280 | 🌐 Python | 📅 2026-06-18: Deezer source separation library (note: Demucs now preferred)
* [Demucs](https://github.com/facebookresearch/demucs) ⚠️ Archived: State-of-the-art music source separation from Meta
* [Asteroid](https://github.com/asteroid-team/asteroid) ⭐ 2,589 | 🐛 56 | 🌐 Python | 📅 2026-05-13: PyTorch-based audio source separation toolkit for researchers
* [audio-separator](https://github.com/nomadkaraoke/python-audio-separator) ⭐ 1,379 | 🐛 27 | 🌐 Python | 📅 2026-08-27: Easy stem separation using MDX-Net VR Arch and Demucs models
...
* [basic-pitch](https://github.com/spotify/basic-pitch) ⭐ 5,618 | 🐛 61 | 🌐 Python | 📅 2025-11-13: Spotify's lightweight neural network for polyphonic pitch detection
* [MT3](https://github.com/magenta/mt3) ⭐ 1,755 | 🐛 51 | 🌐 Python | 📅 2026-09-15: Multi-instrument automatic music transcription from Google Magenta
...
* [AudioCraft](https://github.com/facebookresearch/audiocraft) ⭐ 23,649 | 🐛 398 | 🌐 Jupyter Notebook | 📅 2026-03-03: Meta's library for MusicGen AudioGen EnCodec and MAGNeT models
...
* [Stable Audio Tools](https://github.com/Stability-AI/stable-audio-tools) ⭐ 3,867 | 🐛 132 | 🌐 Python | 📅 2026-09-18: Generative models for conditional audio generation from Stability AI
...
* [music21](https://github.com/cuthbertLab/music21) ⭐ 2,588 | 🐛 158 | 🌐 Python | 📅 2026-09-23: Toolkit for computer-aided musical analysis
...
* [scamp](https://github.com/MarcTheSpark/scamp) ⭐ 153 | 🐛 9 | 🌐 Python | 📅 2026-09-23: Suite for Computer-Assisted Music in Python
...
* [discord.py](https://github.com/Rapptz/discord.py) ⭐ 16,189 | 🐛 173 | 🌐 Python | 📅 2026-09-07: Python wrapper for Discord API with music streaming
* [beets](https://github.com/beetbox/beets) ⭐ 15,699 | 🐛 707 | 🌐 Python | 📅 2026-09-23: Music library manager and MusicBrainz tagger
* [pygame.mixer](https://github.com/pygame/pygame) ⭐ 8,945 | 🐛 794 | 🌐 C | 📅 2025-11-01: Pygame module for sound loading and playback
* [Mopidy](https://github.com/mopidy/mopidy) ⭐ 8,587 | 🐛 178 | 🌐 Python | 📅 2026-09-19: Extensible music server written in Python
...
* [pyAV](https://github.com/PyAV-org/PyAV) ⭐ 3,289 | 🐛 6 | 🌐 Python | 📅 2026-09-23: Pythonic bindings for FFmpeg libraries
* [pyglet](https://github.com/pyglet/pyglet) ⭐ 2,213 | 🐛 33 | 🌐 Python | 📅 2026-09-23: Cross-platform windowing and multimedia library
...
* [Whisper tutorial](https://github.com/openai/whisper/discussions/categories/guides) ⭐ 109,525 | 🐛 151 | 🌐 Python | 📅 2026-08-31: Using OpenAI Whisper for speech-to-text
* [AudioCraft tutorial](https://github.com/facebookresearch/audiocraft/blob/main/docs/MUSICGEN.md) ⭐ 23,649 | 🐛 398 | 🌐 Jupyter Notebook | 📅 2026-03-03: Getting started with MusicGen and AudioGen
